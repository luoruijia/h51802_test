...
(function($){
	...
	$.extend(Carousel.prototype,{
		...
		createDom : function(container){
		    ...
		    //为放置轮播图的容器添加自定义的类名
		    this.container.addClass("mm_container");
	...
	lis += `<li ${ i==0 ? 'style="display:block;"' : ''}>
		    ...
		    //保存属性
		    this.lis = $("li",this.container); //所有轮播图片的李盒子
	...
	//插件
	//向jQuery.prototype 中扩展添加carousel 方法
